<?php
	...
	if ($validated == 1) {
		...
		$campaign_name = NULL; if (isset($_POST["campaign_name"])) { 
			$campaign_name = $_POST["campaign_name"]; 
			$campaign_name = stripslashes($campaign_name);
		}

		$campaign_desc = NULL; if (isset($_POST["campaign_desc"])) { 
		...
		$campaign_rec_filename = NULL; if (isset($_POST["campaign_rec_filename"])) { 
			$campaign_rec_filename = $_POST["campaign_rec_filename"]; 
			$campaign_rec_filename = stripslashes($campaign_rec_filename);
		}
		
		$next_agent_call = NULL; if (isset($_POST["next_agent_call"])) { 
		...
		$customer_3way_hangup_seconds = NULL; if (isset($_POST["customer_3way_hangup_seconds"])) { 
		...
		$customer_3way_hangup_action = NULL; if (isset($_POST["customer_3way_hangup_action"])) { 
		...
		if (is_array($_POST["closer_campaigns"])) {
			...
			$closerCampaigns .= "- ";
		} else { $closerCampaigns = $closer_campaigns; }
