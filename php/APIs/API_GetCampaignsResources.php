<?php
    ...
    if ($leadscount == 0){   
            echo '<div class="media-box-heading"><div class="media-box-heading"><strong>
                    <a id="onclick-campaigninfo" data-toggle="modal" data-target="#view_campaign_information" data-id="'.$campid.'" class="text-danger m0">'.$campname.'</a></strong>
                    </div>
                    <p class="m0">
                    <small ><strong><a id="onclick-campaigninfo" data-toggle="modal" data-target="#view_campaign_information" data-id="'.$campid.'" class="text">'.$campid.'</a></strong>
                    </small>
        ...
        if ($leadscount > 0){ 
            echo '<div class="media-box-heading"><div class="media-box-heading"><strong>
                    <a id="onclick-campaigninfo" data-toggle="modal" data-target="#view_campaign_information" data-id="'.$campid.'" class="text-warning m0">'.$campname.'</a></strong>
                    </div>
                    <p class="m0">
                    <small><strong><a id="onclick-campaigninfo" data-toggle="modal" data-target="#view_campaign_information" data-id="'.$campid.'" class="text">'.$campid.'</a></strong>
                    </small>
