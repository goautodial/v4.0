										...
										<table id="custom_fields_table" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
											...
											<tbody>
												...
												<tr class="field-row">
													...
													<td style="width: 20%;">
														<button type="button" class="btn btn-primary btn-edit-cf" data-list-id="<?php echo $modifyid; ?>" data-info="<?php echo htmlspecialchars(json_encode($fieldsvalues, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE), ENT_QUOTES, 'UTF-8'); ?>"><span class="fa fa-pencil"></span></button>
