														...
														<div class="col-lg-12 option_menu_<?php echo $i;?> mb mt">
																			...
																			<?php
																				...
																				for($x=0;$x < count($ingroups->group_id);$x++){
																					$ingroup_option .= '<option value="'.$ingroups->group_id[$x].'"';
																						if($ivr_options->option_route_value[$i] == $ingroups->group_id[$x]){$ingroup_option .= ' selected';}
															...
															<!-- EXTENSION -->
																<div class="route_exten_<?php echo $i;?>" <?php if($ivr_options->option_route[$i] != "EXTENSION")echo 'style="display:none;"'; ?> >
																	<div class="col-sm-6">
																		...
																		<div class="col-sm-9">
																			<input type="text" class="form-control" name="option_route_value[]" value="" id="option_route_value_<?php echo $i;?>" value="<?php if($ivr_options->option_route[$i] != "EXTENSION"){echo $ivr_options->option_route_value[$i];} ?>" />
																		</div>
																	</div>
																	<div class="col-sm-6">
																		<label class="col-sm-3 control-label">Context: </label>
																		<div class="col-sm-9">
																			<input type="text" class="form-control" name="option_route_value_context[]" value="" id="option_route_value_context_<?php echo $i;?>" value="<?php if($ivr_options->option_route[$i] == "EXTENSION"){echo $ivr_options->option_route_value_context[$i];} ?>" />
																		</div>
																	</div>
																</div>
															<!-- PHONE -->
															...
															<!-- VOICEMAIL -->
																<div class="route_voicemail_<?php echo $i;?>" <?php if($ivr_options->option_route[$i] != "VOICEMAIL")echo 'style="display:none;"'; ?> >
																	...
																	<div class="col-sm-9">
																		<div class="col-sm-6">
																			<input type="text" name="option_route_value[]" value="" class="form-control" id="option_voicemail_input_<?php echo $i;?>" value="<?php if($ivr_options->option_route[$i] != "VOICEMAIL"){echo $ivr_options->option_route[$i];} ?>" maxlength="255" size="15">
																		</div>
																		<div class="col-sm-6">
															...
															<!-- AGI -->
																<div class="route_agi_<?php echo $i;?>" <?php if($ivr_options->option_route[$i] != "AGI")echo 'style="display:none;"'; ?> >
																	...
																	<div class="col-sm-6">
																		<input type="text" class="form-control" name="option_route_value[]" value="" maxlength="255" size="50" value="<?php if($ivr_options->option_route[$i] == "AGI"){echo $ivr_options->option_route[$i];} ?>">
																	</div>
																</div>
														</div>
													</div>
