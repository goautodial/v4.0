...
$(document).ready(function() {
    ...
    $("#go_agent_status").append("<li><div id='RecordControl' class='center-block hidden-xs' style='text-align: center;'><button id='btnRecordCall' title='<?=$lh->translationFor('start_recording')?>' class='btn btn-danger' style='margin: 0 5px 5px 0; font-size: 16px;'><?=$lh->translationFor('start_recording')?></button></div></li>");
